          ...
          },
          {
            ...
            fields: [
              ...
              { type: "string", name: "ctaButton", label: "Кнопка CTA" },
              {
                ...
                description: "Подписи под цифрами в карточках форматов",
                fields: [
                  { type: "string", name: "profitMonth", label: "Подпись под цифрой прибыли", description: "Напр. «Прибыль / мес»" },
                ],
              },
              {
                type: "object",
              ...
              { type: "string", name: "disclaimer", label: "Дисклеймер", ui: { component: "textarea" } },
              {
                type: "object",
                name: "plans",
                label: "Форматы (карточки карусели)",
                description: "Каждая карточка = формат франшизы. Прибыль редактируется прямо в карточке.",
                list: true,
                ui: { component: "group-list" },
                fields: [
                  { type: "string", name: "id", label: "ID (island|multibrand|renovation|manwomen|brandstore)", description: "Не менять — по нему работает карусель и формы" },
                  { type: "string", name: "tagline", label: "Тэглайн (короткая подпись)" },
                  { type: "string", name: "name", label: "Название формата" },
                  ...
                  { type: "string", name: "profit", label: "Прибыль / мес", description: "Показывается на карточке, напр. «от 300 тыс ₽»" },
                ],
              },
            ],
          },
        ...
        templates: [
          {
            ...
            fields: [
              ...
              { type: "string", name: "heroDesc", label: "Описание", ui: { component: "textarea" } },
              {
                ...
                description: "Напр.: 0 ₽ / Взнос, 0% / Роялти, 11 / Магазинов",
                list: true,
                ui: { component: "group-list" },
                fields: [
                  { type: "string", name: "value", label: "Значение", description: "Напр. «0 ₽», «0%», «11»" },
                  { type: "string", name: "label", label: "Подпись", description: "Напр. «Взнос», «Роялти», «Магазинов»" },
                ],
              },
            ],
          },
          {
            ...
            fields: [
              ...
              { type: "string", name: "plansDisclaimer", label: "Дисклеймер под карточками", ui: { component: "textarea" } },
              {
                type: "object",
                name: "plansList",
                label: "Форматы",
          ...
          },
          {
            ...
            fields: [
              ...
              { type: "string", name: "comparisonParamLabel", label: "Заголовок колонки параметров", description: "Напр. «Параметр»" },
              {
                type: "object",
                name: "comparisonRows",
          ...
          },
          {
            ...
            fields: [
              ...
              { type: "string", name: "contactDesc", label: "Описание" },
              {
                ...
                name: "formLabels",
                label: "Подписи формы",
                description: "Все тексты формы заявки",
                fields: [
                  { type: "string", name: "name", label: "Имя (label)" },
                  { type: "string", name: "namePlaceholder", label: "Имя (placeholder)" },
                  { type: "string", name: "phone", label: "Телефон (label)" },
                  { type: "string", name: "format", label: "Формат (label)" },
                  { type: "string", name: "formatPlaceholder", label: "Формат (placeholder)" },
                  { type: "string", name: "city", label: "Город (label)" },
                  { type: "string", name: "cityPlaceholder", label: "Город (placeholder)" },
                  { type: "string", name: "message", label: "Комментарий (label)" },
                  { type: "string", name: "messagePlaceholder", label: "Комментарий (placeholder)" },
                  { type: "string", name: "submit", label: "Кнопка отправки" },
                  { type: "string", name: "submitting", label: "Отправка…" },
                  { type: "string", name: "submitted", label: "Отправлено ✓" },
                  { type: "string", name: "success", label: "Текст успеха" },
                  { type: "string", name: "error", label: "Текст ошибки" },
                  { type: "string", name: "telegram", label: "Telegram (текст ссылки)" },
                  { type: "string", name: "or", label: "или" },
                  { type: "string", name: "mail", label: "почта (текст ссылки)" },
