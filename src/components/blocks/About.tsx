        ...
        >
          ...
          <div className="flex flex-col justify-end">
            <motion.p
              ...
              style={{ willChange: "transform, opacity" }}
            >
              Один из крупнейших fashion-брендов Восточной Европы. Сильный характер, уверенность, позитивная энергия — личность бренда для тех, кто живёт активно и ищет разнообразие. Более 400 магазинов в 20+ странах мира. Почти 30 лет задаёт стандарты стиля для активных людей.
            </motion.p>
          </div>
        </div>
