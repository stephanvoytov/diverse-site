...
export const collections: Collection[] = [
  {
    ...
    tag: "Флагман",
    vibe:
      "Сильный характер, уверенность, позитивная энергия, свежесть — личность бренда Diverse. Более 30 лет бренд черпает вдохновение из последних модных трендов, выбирая самое интересное и адаптируя под свой харизматичный характер. Качество сопоставимо с мировыми гигантами — по доступной цене.",
    colorFrom: "#1a1a2e",
    colorTo: "#16213e",
    image: "diverse.jpg",
