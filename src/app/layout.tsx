...
export const metadata: Metadata = {
  ...
  title: "Франшиза магазина одежды Diverse — открыть по франшизе | 0₽ взнос, 0% роялти",
  description:
    "Франшиза магазина одежды Diverse: паушальный взнос 0₽, роялти 0%. 3 формата: остров от 800 тыс ₽, реновация и полный стандарт. 11 магазинов в РФ и Казахстане. Станьте партнёром бренда — открыть магазин одежды по франшизе.",
  icons: {
    icon: [
  ...
  twitter: {
    ...
    description:
      "Откройте магазин одежды Diverse по франшизе. 3 формата, полное сопровождение 24/7. Без паушального взноса и роялти.",
    images: [`${basePath}/images/hero/main.jpg`],
  },
  openGraph: {
    title: "Франшиза магазина одежды Diverse",
    description:
      "Франшиза польского бренда одежды с 30-летней историей. 400+ магазинов, партнёр Dakar Rally. 3 формата: от 800 тыс ₽. 0₽ взнос, 0% роялти.",
