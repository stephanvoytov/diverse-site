...
export const metadata: Metadata = {
  ...
  title: "Франшиза магазина одежды Diverse",
  description:
    "Европейский бренд одежды Diverse — франшиза с вложениями от 800 тыс ₽. Паушальный взнос 0₽, роялти 0%. 3 формата открытия: POP-UP STORE, реновация и полный стандарт. Более 400 магазинов в мире, 11 в РФ и Казахстане. Собственное производство, полное сопровождение 24/7.",
  icons: {
    icon: [
  ...
  twitter: {
    ...
    title: "Франшиза магазина одежды Diverse — 0₽ взнос, 0% роялти",
    description:
      "Франшиза европейского бренда одежды: вложения от 800 тыс ₽. 3 формата, полное сопровождение 24/7. Без паушального взноса и роялти. Более 400 магазинов в мире.",
    images: [`${basePath}/images/hero/main.jpg`],
  },
  openGraph: {
    title: "Франшиза магазина одежды Diverse",
    description:
      "Европейский бренд одежды Diverse с 30-летней историей. 400+ магазинов в мире, партнёр Dakar Rally и 24H Le Mans. 3 формата франшизы: от 800 тыс ₽ вложений. 0₽ взнос, 0% роялти.",
  ...
  keywords: [
    "франшиза", "франшиза магазина одежды", "франшизы одежды",
    "франшиза Diverse", "бренд Diverse",
    "открыть магазин одежды по франшизе",
    "франшизы в россии", "лучшие франшизы",
