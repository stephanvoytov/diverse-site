          ...
          <div className="container-brand max-w-4xl">
            ...
            <div className="space-y-6 text-base md:text-lg text-brand-gray-400 leading-relaxed">
              <motion.p
                ...
                viewport={{ once: true }}
              >
                <strong className="text-brand-black">Diverse</strong> — бренд для людей, ищущих разнообразие, живущих активно. Для тех, чья одежда — манифест образа жизни: открытость, спонтанность, готовность исследовать неизведанные территории, опыты и идеи.
              </motion.p>
              <motion.p
                initial={{ opacity: 0, y: 15 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                <strong className="text-brand-black">Сильный характер, уверенность, позитивная энергия, свежесть</strong> — черты, определяющие уникальную личность бренда. Почти 30 лет Diverse отвечает требованиям активных людей, ценящих комфорт, качество и стиль. Бренд черпает вдохновение из последних модных трендов, выбирая самое интересное и адаптируя под харизматичный характер Diverse.
              </motion.p>
              <motion.p
                initial={{ opacity: 0, y: 15 }}
                whileInView={{ opacity: 1, y: 0 }}
