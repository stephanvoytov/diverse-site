          ...
          <div className="container-brand max-w-4xl">
            ...
            <div className="space-y-6 text-base md:text-lg text-brand-gray-400 leading-relaxed">
              <motion.p
                ...
                viewport={{ once: true }}
              >
                ETOS S.A. — один из крупнейших и наиболее динамично развивающихся производителей одежды в Польше, ежедневно работающий над созданием сильного и последовательного имиджа своих брендов в соответствии с последними мировыми трендами.
              </motion.p>
              <motion.p
                initial={{ opacity: 0, y: 15 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                На протяжении более 30 лет компания страстно исследует мир моды, прислушиваясь к потребностям клиентов и отвечая на их меняющиеся ожидания. Продукция ETOS отличается инновационным подходом, функциональностью, прочностью и исключительным комфортом носки.
              </motion.p>
              <motion.p
                initial={{ opacity: 0, y: 15 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                <span className="text-brand-black">Diverse</span> — флагманский бренд ETOS, вдохновлённый образом жизни городских жителей. Сегодня это один из самых узнаваемых брендов Польши. Руководствуясь концепцией «Generation to Generation», Diverse создаёт вневременную одежду, которая может служить долгие годы и передаваться из поколения в поколение. Коллекции отличаются превосходным качеством исполнения, вниманием к деталям и высококачественными материалами.
              </motion.p>
            </div>
          </div>
        </section>
